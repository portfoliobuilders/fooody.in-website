...
**Revamp briefing (paste both into Cursor/ChatGPT):**

- [`FOOODY-COMPLETE-ARCHITECTURE.md`](./FOOODY-COMPLETE-ARCHITECTURE.md) — what is built today (also in `docs/`)
- [`FOOODY-REVAMP-MASTER-PLAN.md`](./FOOODY-REVAMP-MASTER-PLAN.md) — what to build next, phase by phase
