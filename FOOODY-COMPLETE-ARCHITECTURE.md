...
**Canonical copy:** also at the repository root as [`../FOOODY-COMPLETE-ARCHITECTURE.md`](../FOOODY-COMPLETE-ARCHITECTURE.md). Pair it with [`../FOOODY-REVAMP-MASTER-PLAN.md`](../FOOODY-REVAMP-MASTER-PLAN.md).
